...
**Exercise:** With this in mind, use a space-separated list of targets (instead of one filename) in your command to generate multiple targets. Use the `-F` to force the re run of the whole workflow or delete your `results/` folder beforehand.
